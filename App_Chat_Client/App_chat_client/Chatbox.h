...
#define BTN_REFRESH_TEAM 305
#define EDIT_TYPING_MESS 306
#define BTN_CREATE_TEAM 307
...
void addControlChatbox(HWND hwnd) {
	...
	// list box Team
	CreateWindowW(L"STATIC", L" online teams ", WS_VISIBLE | WS_CHILD | SS_CENTER, 295, 20, 150, 18, hwnd,
		NULL, NULL, NULL);
	hListTeams = CreateWindowW(L"listbox", L"IDC_TEAM", WS_VISIBLE | WS_CHILD | WS_BORDER| ES_AUTOHSCROLL  | LBS_NOTIFY,
			290, 45, 141, 135, hwnd, (HMENU)LB_TEAM, NULL, NULL);	
	/*CreateWindowW(L"BUTTON", L"Refresh", WS_VISIBLE | WS_CHILD | SS_CENTER, 340, 182, 70, 27, hwnd,
		(HMENU)BTN_REFRESH_TEAM, NULL, NULL);*/
	...
	/*CreateWindowW(L"BUTTON", L"CREATE TEAM", WS_VISIBLE | WS_CHILD | SS_CENTER, 331, 293, 120, 50, hwnd,
		(HMENU)BTN_CREATE_TEAM, NULL, NULL);*/
